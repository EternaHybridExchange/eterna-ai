...
Guides through deposit address, chain selection, deposit monitoring via the sandbox SDK, transfer from Funding to Trading wallet, and balance confirmation.

### `withdraw` — withdraw funds

Check withdrawable balance, submit withdrawal, and track status through the sandbox SDK.
